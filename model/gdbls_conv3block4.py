...
class GDBLS(nn.Module):
    def __init__(
        ...
        self.upsample4 = nn.UpsamplingBilinear2d(scale_factor=8)
        self.conv2d4 = conv1x1(in_planes=filters[2], out_planes=filters[0])
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        ...
        p4 = self.fb4(p3)   # batchsize,256,2,2
        ...
        p4 = self.upsample4(p4)  # 2,2 -> 16,16, upsample factor = 8
        p4 = self.conv2d4(p4)  # 1x1 conv
        p4 = self.flatten3(p4, start_dim=1)  # [batchsize,32768]=batchsize*(128*16*16)
